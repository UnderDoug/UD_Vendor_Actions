...
{
    /// <summary>
    /// An <see cref="IPart"/> designed for Items that should always be available to offer one or more <see cref="UD_VendorAction"/> to <see cref="UD_GetVendorActionsEvent"/>, including if this mod is enabled mid-save.
    /// </summary>
    /// <remarks>
